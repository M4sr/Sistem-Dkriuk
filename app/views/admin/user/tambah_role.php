    ...
    <div class="row align-items-center mb-4 g-3">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="font-size: 12px;">
                        ...
                        <li class="breadcrumb-item active text-danger fw-bold" aria-current="page">Tambah Role</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="col-md-5 text-md-end">
            <div class="d-flex gap-2 justify-content-md-end">
                ...
                <button type="submit" form="formTambahRole" class="btn btn-danger shadow-sm px-4 fw-bold rounded-3 w-100 w-md-auto d-flex justify-content-center align-items-center">Simpan</button>
            </div>
        </div>
    </div>

    <form action="<?= BASEURL; ?>/admin/proses_tambah_role" method="post" id="formTambahRole">
        <div class="row g-4">
            <!-- Role Info -->
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_role" class="form-control rounded-3 py-2" placeholder="Contoh: Manager Operasional" required>
                        </div>
                        <div class="mb-0">
                            <label class="form-label small fw-bold">Deskripsi Tugas</label>
                            <textarea name="deskripsi" class="form-control rounded-3" rows="4" placeholder="Jelaskan tanggung jawab role ini..."></textarea>
                        </div>
                    </div>
                </div>

                <div class="card border-0 shadow-sm rounded-4 bg-light bg-opacity-50 border border-dashed p-4 text-center">
                    <i class="fas fa-shield-alt text-muted fs-1 mb-3"></i>
                    <h6 class="fw-bold">Tips Keamanan</h6>
                    <p class="small text-muted mb-0">Berikan izin akses hanya pada fitur yang benar-benar dibutuhkan oleh staf. Terlalu banyak izin akses bisa meningkatkan risiko keamanan data.</p>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="permission-item border rounded-3 p-3 transition-all h-100">
                                    <div class="form-check d-flex align-items-center justify-content-between p-0">
                                        ...
                                        <input class="form-check-input ms-0 mt-0 perm-checkbox" type="checkbox" name="permissions[]" value="<?= $p['id']; ?>" id="perm_<?= $p['id']; ?>" style="width: 20px; height: 20px;">
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
